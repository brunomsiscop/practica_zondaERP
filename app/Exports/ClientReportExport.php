...
use Carbon\Carbon;
class ClientReportExport implements FromCollection, WithHeadings, WithMapping
{
    protected $customers;
    protected $metrics;
    ...
    public function headings(): array
    {
        ...
        if (in_array('inc_pest_count', $this->metrics)) { $headers[] = 'Cantidad de plagas asociadas.'; } // Checkbox e.
    ...
    public function map($customer): array
    {
        ...
        if (in_array('inc_pest_count', $this->metrics)) { $row[] = $customer->pest_count; } // Muestra el total numérico de plagas
