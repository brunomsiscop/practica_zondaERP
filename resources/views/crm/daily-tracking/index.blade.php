                            ...
                            <div class="container-fluid font-small p-3">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('crm.daily-tracking.charts', request()->query()) }}">
                                ...
                                @if (session('import_result'))
                                    @php
                                        ...
                                        $daily = $importResult['daily_tracking'] ?? [
                                            'inserted' => 0,
                                            'updated' => 0,
                                            'skipped' => 0,
                                            'skipped_rows' => [],
                                        ...
                                        $prospects = $importResult['commercial_prospects'] ?? [
                                            'inserted' => 0,
                                            'updated' => 0,
                                            'skipped' => 0,
                                            'skipped_rows' => [],
                                    ...
                                    <div class="alert alert-info border mb-3">
                                        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                                            <div>
                                                ...
                                                <small class="text-muted">Los prospectos se guardan en la tabla de
                                                    prospectos comerciales y no aparecen en esta tabla de actividades
                                                    diarias.</small>
                                            </div>
                                        ...
                                        @if ($totalSkippedRows > 0)
                                            <div class="mt-3">
                                                <button type="button" class="btn btn-outline-danger btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#skippedRowsImportModal">
                                                    <i class="bi bi-list-ul"></i> Ver filas no insertadas
                                                    ({{ $totalSkippedRows }})
                                                </button>
                                            </div>
                                        @endif
                                            ...
                                            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="skippedRowsImportModalLabel">Filas no
                                                            insertadas en importación</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Cerrar"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        @if (!empty($dailySkippedRows))
                                                            <h6 class="mb-2">Registro_Diario_CRM
                                                                ({{ count($dailySkippedRows) }})</h6>
                                                            @foreach ($dailySkippedRows as $row)
                                                                <div class="border rounded p-2 mb-2 bg-light">
                                                                    <div class="small mb-1"><strong>Fila:</strong>
                                                                        {{ $row['row_number'] ?? '-' }}</div>
                                                                    <div class="small mb-2"><strong>Motivo:</strong>
                                                                        {{ $row['reason'] ?? 'Sin detalle' }}</div>
                                                                    <details>
                                                                        <summary class="small">Ver datos de la fila
                                                                        </summary>
                                                        ...
                                                        @if (!empty($prospectsSkippedRows))
                                                            <h6 class="mt-3 mb-2">PROSPECTOS COMERCIALES
                                                                ({{ count($prospectsSkippedRows) }})</h6>
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            ...
                                                            <select name="sort" class="form-select form-select-sm">
                                                                <option value="created_at" @selected(request('sort', 'created_at') === 'created_at')>
                                                                    Creacion</option>
                                                                <option value="service_date" @selected(request('sort') === 'service_date')>
                                                                    Fecha</option>
                                                                <option value="customer_name" @selected(request('sort') === 'customer_name')>
                                                                    Cliente</option>
                                                                <option value="status" @selected(request('sort') === 'status')>Estatus
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-1">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            ...
                                                            <select name="direction" class="form-select form-select-sm">
                                                                <option value="DESC" @selected(strtoupper(request('direction', 'DESC')) === 'DESC')>DESC
                                                                </option>
                                                                <option value="ASC" @selected(strtoupper(request('direction')) === 'ASC')>ASC
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-1">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            ...
                                                            <select name="per_page" class="form-select form-select-sm">
                                                                <option value="15" @selected((int) request('per_page', 15) === 15)>15
                                                                </option>
                                                                <option value="25" @selected((int) request('per_page') === 25)>25
                                                                </option>
                                                                <option value="50" @selected((int) request('per_page') === 50)>50
                                                                </option>
                                                                <option value="100" @selected((int) request('per_page') === 100)>100
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <tbody>
                                            @forelse ($dailyTrackings as $item)
                                                @php
                                                    ...
                                                    $recurrentBadgeClass = $item->is_recurrent
                                                        ? 'text-bg-info'
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="badge {{ $recurrentBadgeClass }}">{{ $recurrentLabel }}</span>
                                                    </td>
                                                    <td>{{ $quotedLabel }}</td>
                                                    <td>{{ $closedLabel }}</td>
                                                            ...
                                                            $invoiceBadgeClass =
                                                                $invoiceValue === 'yes'
                                                                    ...
                                                                    : ($invoiceValue === 'no'
                                                                        ...
                                                                        : 'text-bg-secondary');
                                                            $invoiceLabel =
                                                                $item->invoice?->label() ?? ($invoiceValue ?? '-');
                                                        @endphp
                                                        <span
                                                            class="badge {{ $invoiceBadgeClass }}">{{ $invoiceLabel }}</span>
                                                    </td>
                                                    <td>{{ $item->billed_amount ? '$' . number_format((float) $item->billed_amount, 2) : '-' }}
                                                    </td>
                                                    ...
                                                    <td class="py-2 px-2">
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                data-bs-toggle="tooltip" data-bs-title="Crear cliente"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header bg-warning-subtle">
                                                <h5 class="modal-title" id="createCustomerFromTrackingModalLabel">
                                                    <i class="bi bi-person-plus-fill"></i> Crear cliente desde actividad
                                                    diaria
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            ...
                                            <form id="createCustomerFromTrackingForm" method="POST" action="#">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-info py-2">
                                                        Se tomaran los datos del registro diario seleccionado y podras
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm"
                                                                name="name" id="ct-name" required>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label class="form-label">Telefono</label>
                                                            <input type="text" class="form-control form-control-sm"
                                                                name="phone" id="ct-phone">
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label class="form-label">Tipo de servicio *</label>
                                                            <select class="form-select form-select-sm"
                                                                name="service_type_id" id="ct-service-type" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select class="form-select form-select-sm"
                                                                name="contact_medium" id="ct-contact-medium" required>
                                                                @foreach ($customerContactMediumOptions as $key => $label)
                                                                    <option value="{{ $key }}"
                                                                        @selected($key === 'call')>{{ $label }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="contact_methods[]"
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-info mb-3">
                                                        ...
                                                        <ul class="mb-0">
                                                            ...
                                                            <li>Los registros duplicados se actualizarán automáticamente
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="upload-zone border-2 border-dashed border-primary rounded p-4 text-center"
                                                            id="uploadZone"
                                                            style="cursor: pointer; background-color: #f0f7ff; transition: all 0.3s;">
                                                            <div class="mb-2">
                                                                <i class="bi bi-cloud-arrow-up text-primary"
                                                                    style="font-size: 2.5rem;"></i>
                                                            </div>
                                                            <p class="mb-1 fw-semibold text-primary">Arrastra tu archivo
                                                                aquí o haz clic</p>
                                                    ...
                                                    <div id="importLoadingState"
                                                        class="d-none border rounded p-3 bg-light">
                                                        <div class="d-flex align-items-center gap-2 mb-2">
                                                            <div class="spinner-border spinner-border-sm text-primary"
                                                                role="status" aria-hidden="true"></div>
                                                            <span class="fw-semibold text-primary">Importando
                                                                archivo...</span>
                                                        </div>
                                                        <div class="progress" role="progressbar"
                                                            aria-label="Import progress" aria-valuemin="0"
                                                            aria-valuemax="100">
                                                            <div class="progress-bar progress-bar-striped progress-bar-animated"
                                                                style="width: 100%"></div>
                                                        </div>
                                                        <small class="text-muted d-block mt-2">Esto puede tardar unos
                                                            segundos dependiendo del tamano del archivo.</small>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-outline-secondary"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header bg-warning">
                                                <h5 class="modal-title text-dark"
                                                    id="createCustomerFromTrackingModalLabel">
                                                    <i class="bi bi-person-plus-fill me-1"></i> Crear cliente desde
                                                    registro diario
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            ...
                                            <form id="createCustomerFromTrackingForm" method="POST" action="">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-info small mb-3">
                                                        <i class="bi bi-info-circle"></i>
                                                        Los datos se precargaron del registro seleccionado. Revisa y
                                                        completa los campos requeridos antes de guardar.
                                                    </div>

                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-semibold mb-1">Nombre del cliente
                                                                *</label>
                                                            <div class="input-group input-group-sm">
                                                                <span class="input-group-text"><i
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-semibold mb-1">Correo
                                                                electronico</label>
                                                            <div class="input-group input-group-sm">
                                                                <span class="input-group-text"><i
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-semibold mb-1">Sucursal asignada
                                                                *</label>
                                                            <div class="input-group input-group-sm">
                                                                <span class="input-group-text"><i
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-semibold mb-1">Medio de contacto
                                                                *</label>
                                                            <div class="input-group input-group-sm">
                                                                <span class="input-group-text"><i
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <select name="state" id="ctf_state"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <select name="city" id="ctf_city"
                                                                    class="form-select form-select-sm">
                                                                    <option value="">— Selecciona primero el estado —
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
                                    ...
                                    document.querySelectorAll('.btn-create-customer').forEach(function(btn) {
                                        btn.addEventListener('click', function() {
                                            ...
                                            const modal = new bootstrap.Modal(document.getElementById(
                                                'createCustomerFromTrackingModal'));
                                            modal.show();
                                        });
                                    });
                                })();
