...
Route::prefix('crm')->name('crm.')->middleware(['auth', 'single.session', 'can:integral'])->group(function () {
    ...
    Route::get('/agenda/tracking/export/pdf', [CRMController::class, 'exportTrackingsPdf'])->name('tracking.export.pdf');
    ...
    Route::get('/daily-trackings/export-charts', [DailyTrackingController::class, 'exportCharts'])->name('daily-tracking.export-charts');
